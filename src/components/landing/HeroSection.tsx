...
import { Award, ArrowRight, Code, Smartphone, Rocket } from "lucide-react";
    ...
    <section className="container mx-auto px-4 pt-20 pb-32">
      <div className="text-center max-w-5xl mx-auto space-y-6">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary via-purple-500 to-primary/80 mb-6 leading-tight">
          Build Any Web App & Scale Your Business with Enterprise-Grade AI Technology
        </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-gray-400 max-w-4xl mx-auto">
